...
def get_args_parser():
    ...
    parser.add_argument('--config_file', '-c', type=str, default='config/cfg_coco.py')
    ...
    # dataset parameters
    parser.add_argument("--datasets", type=str, default='config/datasets_od_example.json', help='path to datasets json')
    ...
    parser.add_argument('--pretrain_model_path', help='load from other checkpoint', default='weights/groundingdino_swint_ogc.pth')
    #parser.add_argument('--pretrain_model_path', help='load from other checkpoint', default='output/checkpoint_best_regular.pth')
